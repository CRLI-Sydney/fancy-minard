...
```{r troops-map-2, eval=FALSE, fig.height=2.5, fig.width=10, include=FALSE}
ggplot() +
  geom_path(data = troops, aes(x = long, y = lat, group = group, 
                               color = direction, size = survivors),
            lineend = "round") +
...
```{r russia-minard, eval=FALSE, fig.height=4, fig.width=10, message=FALSE, include=FALSE}
...
```{r temps-2, eval=FALSE, fig.height=4, fig.width=10, include=FALSE}
temps.nice <- temps %>%
...
```{r align-minard, eval=FALSE, include=FALSE}
...
```{r adjust-panels, eval=FALSE, fig.height=5.5, fig.width=10, include=FALSE}
...
```{r combined-simple, eval=FALSE, fig.height=4.75, fig.width=10, include=FALSE}
# No map this time
